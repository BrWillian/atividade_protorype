...
Revision ID: ca3e5ea829e2
Revises: 
Create Date: 2023-06-23 21:49:26.580287
...
def upgrade():
    ...
    sa.Column('cpf_prop', sa.BigInteger(), nullable=False),
    ...
    sa.Column('cod_conjuge', sa.BigInteger(), nullable=True),
    sa.ForeignKeyConstraint(['cod_conjuge'], ['pessoa_fisica.cpf_prop'], ),
    sa.PrimaryKeyConstraint('cpf_prop'),
    sa.UniqueConstraint('cpf_prop')
    )
    op.create_table('pessoa_juridica',
    sa.Column('cnpj_prop', sa.BigInteger(), nullable=False),
    sa.Column('razao_social_pj', sa.String(), nullable=True),
    sa.Column('dt_cria_pj', sa.Date(), nullable=True),
    sa.PrimaryKeyConstraint('cnpj_prop'),
    ...
    sa.ForeignKeyConstraint(['cod_prop_pf'], ['pessoa_fisica.cpf_prop'], ),
    sa.ForeignKeyConstraint(['cod_prop_pj'], ['pessoa_juridica.cnpj_prop'], ),
    ...
    sa.Column('cod_municipio', sa.Integer(), nullable=True),
    sa.Column('valor_aquisicao', sa.Float(), nullable=True),
    sa.ForeignKeyConstraint(['cod_municipio'], ['municipio.cod_municipio'], ),
    ...
    sa.Column('cod_prop_pj', sa.Integer(), nullable=True),
    sa.Column('cod_prop_pf', sa.Integer(), nullable=True),
