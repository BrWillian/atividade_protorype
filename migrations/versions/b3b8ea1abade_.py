...
Revision ID: b3b8ea1abade
Revises: 
Create Date: 2023-06-23 18:44:29.514252
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['cod_prop_pf'], ['propriedade.cod_propriedade'], ),
    ...
    sa.ForeignKeyConstraint(['cod_prop_pj'], ['propriedade.cod_propriedade'], ),
